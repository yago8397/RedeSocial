...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_storage_service__ = __webpack_require__(349);
...
var HomePage = /** @class */ (function () {
    ...
    HomePage.prototype.login = function () {
        ...
        this.firebaseauth.auth.signInWithEmailAndPassword(this.email.value, this.password.value)
            .then(function () {
            _this.mesagem('Login efetuado com sucesso!');
        })
            .catch(function (erro) {
            _this.mesagem('Login incorreto!');
        });
    };
    HomePage.prototype.cadastro = function () {
        ...
        this.firebaseauth.auth.createUserWithEmailAndPassword(this.email.value, this.password.value)
            ...
            .catch(function (erro) {
            _this.mesagem('Cadastro incorreto!');
        });
    };
    HomePage.prototype.mesagem = function (texto) {
